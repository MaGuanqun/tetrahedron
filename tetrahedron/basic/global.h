...
#undef CROSS_SUM 
#define CROSS_SUM(dest,v1,v2,v3,v4) \
dest[0] = v1[1] * v2[2] - v1[2] * v2[1] + v3[1] * v4[2] - v3[2] * v4[1]; \
dest[1] = v1[2] * v2[0] - v1[0] * v2[2] + v3[2] * v4[0] - v3[0] * v4[2]; \
dest[2] = v1[0] * v2[1] - v1[1] * v2[0] + v3[0] * v4[1] - v3[1] * v4[0];
...
//rotation matrix store in row major
inline void rotateAroundVectorRowMajor(double* rotation_matrix, double* rotate_axis, double angle)
{
	...
	rotation_matrix[6] = rotate_axis[0] * rotate_axis[2] * (1.0 - cos_) - rotate_axis[1] * sin_;
	...
	rotation_matrix[2] = rotate_axis[2] * rotate_axis[0] * (1.0 - cos_) + rotate_axis[1] * sin_;
...
inline void barrierGradHessian(double d, double d_hat, double& gradient, double& hessian)
{
	...
	double log_ = std::log(d / d_hat);
	double t2 = d - d_hat;
	gradient = ((t2 / d_hat) * log_ * -2.0 / d_hat
			- ((t2 / d_hat) * (t2 / d_hat)) / d);
	hessian= ((log_ * -2.0 - t2 * 4.0 / d) / (d_hat * d_hat)
