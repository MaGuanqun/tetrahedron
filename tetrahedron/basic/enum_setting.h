...
enum XPBD_IPC_Func {
    ...
    UPDATE_POSITION_AVERAGE, UPDATE_LAST_COLOR_VERTEX_BELONG, COLLISION_FREE_POSITION_FROM_RECORD//UPDATE_TET_GRAD_SHARED, UPDATE_TET_GRAD_SHARED_COLLISION_NEIGHBOR, SOLVE_TET_BLOCK_COLLISION, 
};
