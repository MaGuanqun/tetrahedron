...
enum SpatialHashingFuncSendToThread {
    ...
    RESUM_TARGET_POSITION, CHECK_IF_SIDE_CHANGED, DECIDE_IF_NEED_ITERATION, CCD_CHECK_COLLISION
};

enum CollisionFuncSendToThread {
    FIND_TRIANGLE_PAIRS, FIND_PRIMITIVE_AROUND, GLOBAL_COLLISION_DETECTION, SUM_TARGET_POSITION, RE_DETECTION, RESUM_TARGET_POSITION
};
