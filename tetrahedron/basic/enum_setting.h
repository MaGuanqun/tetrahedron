...
enum ControlPrameter {
    ...
    ONLY_MOVE_CURRENT_POSITION, DRAW_VT, ROTATION, ONLY_ROTATE_CURRENT
};
...
enum ObjectFunc {
    VERTEX_AABB, EDGE_TRIANGLE_AABB, VERTEX_AABB_WITHOUT_TOLERANCE, TETRAHEDRON_AABB, CURRENT_AABB
};
