...
enum ControlPrameter {
    ...
    SET_CURSOR_FORCE, OUTPUT_IMAGE, SAVE_OBJ, START_TEST, INITIAL_TEST, MOVE_OBJ_SCRIPT, MOVE_OBJ,ONLY_COLLISION_TEST, USE__IP,
...
enum CollisionFuncSendToThread {
    ...
    PREFIX_SUM_ALL_PAIRS, UPDATE_COLLISION_HESSIAN_COLOR
...
enum XPBD_IPC_Func {
    SET_POS_PREDICT_, COLLISION_FREE_POSITION_, XPBD_IPC_VELOCITY, UPDATE_TET_HESSIAN_SHARED, SOLVE_TET_BLOCK
};
