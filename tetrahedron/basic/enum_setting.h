...
enum ControlPrameter {
    ...
    USE_PD_, USE_NEWTON_, SHORTCUT_INSTRUCTION, SEARCH_LEFT_SH_CELL, SEARCH_RIGHT_SH_CELL
};
...
enum SpatialHashingFuncSendToThread {
    ...
    ORI_TRIANGLE_HASHING//,  SET_HASH_TOGETHER, PREPARE_FOR_ACTUAL_HASH_VALUE_COUNT_THREAD, ADD_COUNT_FOR_PRIFIX_SUM
