...
enum PDFuncSendToThread {
    ...
    COLLISION_FREE_POSITION, SOLVE_SYSYTEM_WITHOUT_COLLISION, SOLVE_SYSYTEM_WITHOUT_ENERGY,
...
enum ItrSolverMethod {
    DIRECT_SOLVE, JACOBI, CHEBYSHEV_JACOBI, SUPER_JACOBI, CHEBYSHEV_SUPER_JACOBI, GAUSS_SEIDEL, PCG, GAUSS_SEIDEL_CHEBYSHEV
};