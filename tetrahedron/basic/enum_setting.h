...
enum ControlPrameter {
    ...
    SET_CURSOR_FORCE, OUTPUT_IMAGE, SAVE_OBJ, START_TEST, INITIAL_TEST, DRAW_MESH_PATCH
};
...
enum SpatialHashingFuncSendToThread {
    TRIANGLE_HASHING, SCENE_AABB, SH_FIND_ALL_TRIANGLE_PAIRS //,  SET_HASH_TOGETHER, PREPARE_FOR_ACTUAL_HASH_VALUE_COUNT_THREAD, ADD_COUNT_FOR_PRIFIX_SUM
...
enum ObjectFunc {
    VERTEX_AABB, EDGE_TRIANGLE_AABB, VERTEX_AABB_WITHOUT_TOLERANCE
};
