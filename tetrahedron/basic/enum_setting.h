...
enum ControlPrameter {
    ...
    DRAW_ALL_PAIRS_IN_A_CELL, SAVE_SIMULATION_DATA, SAVE_SCENE_DATA, USE_XPBD_LARGE, USE_XPBD_IPC, USE_IPC
};
...
enum SpatialHashingFuncSendToThread {
    ...
    ORI_TRIANGLE_HASHING, FIND_ALL_PAIRS_HASH_TABLE_BY_ELEMENT//COMBINE_HASH_TABLE
...
enum CollisionFuncSendToThread {
    ...
    PREFIX_SUM_ALL_PAIRS, UPDATE_COLLISION_HESSIAN_COLOR, COLOR_COLLISION_TIME, UPDATE_COLOR_POSITION, SET_ELEMENT_COLLIDE_WITH_COLLIDER,
      CLOSE_PAIR_COLLISION_TIME, //FLOOR_COLLISION_TIME, UPDATE_POSITION_FOR_FLOOR_COLLISION,
    COLLISION_FREE_POSITION_ALL,FIND_CLOSE_PAIR, GLOBAL_COLLISION_TIME_ADD_PAIR, UPDATE_RECORD_VERTEX_POSITION, //RECORD_VT_PAIR_COMPRESS, RECORD_EE_PAIR_COMPRESS,RECORD_TRIANGLE_HAS_COLLISION_PAIR,
    COMPUTE_D_HAT_WITH_INDEX_IN_GLOBAL, EXTRACT_ELEMENTS_WITH_COLLIDER, ADD_TET_IN_COLLISION, SET_PAIR_BY_ELEMENT, SUM_COLLISION_HESSIAN,
    UPDATE_RECORD_POSITION_PREVIOUS_COLOR, UPDATE_NEW_PAIR_IN_HASH, COLLISION_GRAD, VERTEX_COLLISION_STENCIL
};
...
enum StiffnessType {
    ...
    DAMP_LENGTH, DAMP_BENDING, DAMP_ARAP, YOUNGS_MODULUS, POISSON_RATIO
};
...
enum XPBD_IPC_Func {
    SET_POS_PREDICT_, COLLISION_FREE_POSITION_, XPBD_IPC_VELOCITY, SOLVE_TET_BLOCK, // UPDATE_TET_HESSIAN,  UPDATE_TET_GRAD_SHARED_COLLISION,
    UPDATE_POSITION_AVERAGE, UPDATE_POSITION_AVERAGE_EXCEPT_THIS_COLOR, UPDATE_LAST_COLOR_VERTEX_BELONG, COLLISION_FREE_POSITION_FROM_RECORD, FIRST_COLOR_ARAP_ENERGY,UPDATE_TET_GRAD_SHARED,UPDATE_TET_GRAD_SHARED_COLLISION_NEIGHBOR, SOLVE_TET_BLOCK_COLLISION,
    INERTIAL_ENERGY, ARAP_ENERGY, COMPUTE_BARRIER_ENERGY, COMPUTE_RPREVIOUS_COLOR_BARRIER_ENERGY, PREVIOUS_COLOR_INERTIAL_ENERGY,
    LAST_COLOR_INERTIAL_ENERGY, LAST_COLOR_ARAP_ENERGY, SUM_ALL_GRAD, WARM_START, INVERSION_TEST, PREVIOUS_COLOR_INVERSION_TEST,
    LAST_COLOR_INVERSION_TEST, TEST_MULTI, TET_GRAD, GRAD_NORM, MAX_DISPLACEMENT_COLOR,
    NEO_HOOKEAN_HESSIAN_GRAD, SUM_NEO_HOOKEAN_HESSIAN, WARM_START_SOLVE_COLLISION, UPDATE_POSITION_AVERAGE_WARM_START
};
