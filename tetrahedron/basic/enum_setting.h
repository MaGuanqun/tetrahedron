...
enum ControlPrameter {
    ...
    DRAW_ALL_PAIRS_IN_A_CELL, SAVE_SIMULATION_DATA, SAVE_SCENE_DATA, USE_XPBD_LARGE
};
...
enum MeshStructFuncSendToThread {
    FACE_NORMAL, VERTEX_NORMAL, FACE_NORMAL_RENDER, VERTEX_NORMAL_RENDER, SET_VOLUME, VERTEX_NORMAL_FROM_RENDER
};
enum MeshStructType {
...
enum MethodFunc {
    PD_, XPBD_, NEWTON_, XPBD_SECOND_ORDER_LARGE_
};