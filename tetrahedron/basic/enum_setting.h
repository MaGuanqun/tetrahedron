...
enum CollisionFuncSendToThread {
    ...
    RECORD_VT_PAIR_COMPRESS, RECORD_EE_PAIR_COMPRESS, RECORD_TRIANGLE_HAS_COLLISION_PAIR, CLOSE_PAIR_COLLISION_TIME, FLOOR_COLLISION_TIME, UPDATE_POSITION_FOR_FLOOR_COLLISION,
    COLLISION_FREE_POSITION_LAST_COLOR,FIND_CLOSE_PAIR, GLOBAL_COLLISION_TIME_ADD_PAIR, UPDATE_RECORD_VERTEX_POSITION
};
...
enum XPBD_IPC_Func {
    ...
    SOLVE_TET_BLOCK_COLLISION, UPDATE_TET_GRAD_SHARED_COLLISION_NEIGHBOR, UPDATE_POSITION_AVERAGE, UPDATE_LAST_COLOR_VERTEX_BELONG
};
