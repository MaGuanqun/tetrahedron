...
enum CollisionFuncSendToThread {
    ...
    RE_COLLISION_CONSTRAINT, FIND_COLLISION_PAIR
};
...
enum DrawCullingFunc {
    MOVE_OBJECT, SET_POSITION_COLOR, SET_DATA_TOGETHER, MOVE_OBJECT2
};
...
enum XPBDFunc {
    SET_POS_PREDICT, SET_POS_PREDICT_SUB_TIME_STEP, XPBD_VELOCITY
};