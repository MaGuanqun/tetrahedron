...
enum CollisionFuncSendToThread {
    ...
    PREFIX_SUM_ALL_PAIRS, UPDATE_COLLISION_HESSIAN_COLOR, COLOR_COLLISION_TIME, UPDATE_COLOR_POSITION    
};
...
enum XPBD_IPC_Func {
    SET_POS_PREDICT_, COLLISION_FREE_POSITION_, XPBD_IPC_VELOCITY, SOLVE_TET_BLOCK, UPDATE_TET_HESSIAN, UPDATE_TET_GRAD_SHARED
};
