...
enum SpatialHashingFuncSendToThread {
    ...
    FIND_ALL_TRIANGLE_PAIRS_HASH_TABLE, TRIANGLE_HASHING_RECORD_REAL_HASH_VALUE, PREFIX_SUM_MULTI_2,
    ...
    FIND_ALL_TRIANGLE_PAIRS_HASH_TABLE_COMPARE//,  SET_HASH_TOGETHER, PREPARE_FOR_ACTUAL_HASH_VALUE_COUNT_THREAD, ADD_COUNT_FOR_PRIFIX_SUM
