...
enum CollisionFuncSendToThread {
    ...
    COLLISION_FREE_POSITION_LAST_COLOR,FIND_CLOSE_PAIR, GLOBAL_COLLISION_TIME_ADD_PAIR, UPDATE_RECORD_VERTEX_POSITION, //RECORD_VT_PAIR_COMPRESS, RECORD_EE_PAIR_COMPRESS,RECORD_TRIANGLE_HAS_COLLISION_PAIR,
...
enum XPBD_IPC_Func {
    ...
    UPDATE_POSITION_AVERAGE, UPDATE_LAST_COLOR_VERTEX_BELONG, COLLISION_FREE_POSITION_FROM_RECORD, FIRST_COLOR_ARAP_ENERGY,UPDATE_TET_GRAD_SHARED,UPDATE_TET_GRAD_SHARED_COLLISION_NEIGHBOR, SOLVE_TET_BLOCK_COLLISION, 
