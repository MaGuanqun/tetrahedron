...
private:
	...
	void lsdSort(unsigned int* value, unsigned int* triangle_index, unsigned int list_size,
		unsigned int& largest_count);
	...
	void reorder_(unsigned int* value, unsigned int* stack_value, unsigned int* triangle_index, unsigned int* stack_triangle_index, unsigned int move_byte, unsigned int* index_bucket, unsigned int array_index_start, unsigned int array_index_end);
	...
	void lsdSortSingleThread(unsigned int* value, unsigned int* triangle_index, unsigned int list_size, unsigned int& largest_count);
