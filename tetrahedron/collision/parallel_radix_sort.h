...
private:
	...
	int key_num;
	void addCount(int size, int* count_bucket, int move_byte, std::array<int, 2>* array);
	void addCount(int array_begin, int array_end, int* count_bucket, int move_byte, std::array<int, 2>* array);
	void reorder(std::array<int, 2>* array, std::array<int, 2>* stack, int move_byte, int* index_bucket, int size);
	...
	void reorder(std::array<int, 2>* array, std::array<int, 2>* stack, int move_byte, int* index_bucket, int array_index_start, int array_index_end);
};
