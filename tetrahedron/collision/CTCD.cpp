...
bool CTCD::edgeEdgeCTCD(const Eigen::Vector3d &q0start,  //initial_edge_vertex_1
                        const Eigen::Vector3d &p0start,  //initial_edge_vertex_0
                        const Eigen::Vector3d &q1start,  //initial_compare_edge_vertex_1
                        const Eigen::Vector3d &p1start,  //initial_compare_edge_vertex_0
                        ...
                        double &t)
{
    ...
    Vector3d vp0 = p0end-p0start;  //v0
    Vector3d vp1 = p1end-p1start;  //v2
    Vector3d vq0 = q0end-q0start;  //v1
    Vector3d vq1 = q1end-q1start;  //v3
