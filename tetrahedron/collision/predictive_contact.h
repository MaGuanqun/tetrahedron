...
public:
	...
	bool pointColliderTriangleCollision(double* initial_position, double* current_position, std::vector<double*>& initial_triangle_position, std::vector<double*>& current_triangle_position,
		double* initial_triangle_normal, double* current_triangle_normal,
...
private:
	...
	double normal_magnitude_reciprocal, double vertex_mass, double* triangle_mass);
	bool checkIfCollidePointColliderTriangle(double* initial_point_position, double* current_point_position,
	...
	void obtainPointColliderTriangleTargetPosition(double* point_position,double* vertex_target_pos, double radius,
