...
bool ApproxCCD::pointTriangleCollisionTime(double& alpha, double* initial_position, double* current_position,
...
bool ApproxCCD::edgeEdgeCollisionTime(double& alpha, double* current_edge_vertex_0, double* current_edge_vertex_1, double* initial_edge_vertex_0, double* initial_edge_vertex_1,
