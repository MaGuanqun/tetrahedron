...
public:
	...
	void solveHessianForNeighborTet(unsigned int*& common_vertex_in_order,
	...
	bool computeBarrierEEGradientHessian(double* ea0, double* ea1, double* eb0, double* eb1, MatrixXd& h, VectorXd& g,
		int* vertex_in_pair, double stiffness, double d_hat_2, double rest_length_0, double rest_length_1, bool compute_hessian, bool is_collider);

	bool computeBarrierEEGradientHessianTest(double* ea0, double* ea1, double* eb0, double* eb1, MatrixXd& h, VectorXd& g,
...
private:
	...
	void 	setBarrierGHWithMollifier(double barrier_, MatrixXd& dis_h, VectorXd& dis_g,
		...
		double ee_cross_norm_2, double mollifier, double b_grad, double b_hessian, bool compute_hessian, bool is_collider);
